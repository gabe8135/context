...
export default async function Projects({ searchParams }) {
  ...
  const { data, error } = await supabase.from("projects").select("id,name,slug,status,priority,progress,due_at,clients(name)").eq("workspace_id", workspaceId).is("archived_at", null).order("updated_at", { ascending: false });
